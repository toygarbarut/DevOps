...
locals {
  github-email    = "xxxxxxxxxxxxxxxxxxxx"     # you need to change this line
  github-username = "xxxxxxxxxxxxxxxxxxxx"     # you need to change this line
  github-token    = "xxxxxxxxxxxxxxxxxxxx"     # you need to change this line
  key_pair        = "xxxxxxxxxxxxxxxxxxxx"     # you need to change this line
  pem_key_address = "~/.ssh/xxxxxxxxxxxxx"     # you need to change this line with.pem
}
